...
local Update = function(self, event, unit)
	...
	local r, g, b, t
	if(power.colorTapping and isBetaClient and UnitIsTapDenied(unit) or
		(not UnitPlayerControlled and UnitIsTapped(unit) and not UnitIsTappedByPlayer(unit) and not
