...
local function CastStart(self, event, unit)
	...
	if safeZone then
		...
		if element.casting then
			safeZone:SetPoint(
				element:GetReverseFill() and (isHoriz and 'LEFT' or 'BOTTOM') or (isHoriz and 'RIGHT' or 'TOP')
			)
		else
			safeZone:SetPoint(
				element:GetReverseFill() and (isHoriz and 'RIGHT' or 'TOP') or (isHoriz and 'LEFT' or 'BOTTOM')
			)
		end
